...
export const ReportDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/reportservice/report${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reportserviceApp.reportserviceReport.delete.question">
        <Translate contentKey="reportserviceApp.reportserviceReport.delete.question" interpolate={{ id: reportEntity.id }}>
