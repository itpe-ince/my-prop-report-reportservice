...
export const BathroomDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/reportservice/bathroom${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reportserviceApp.reportserviceBathroom.delete.question">
        <Translate contentKey="reportserviceApp.reportserviceBathroom.delete.question" interpolate={{ id: bathroomEntity.id }}>
