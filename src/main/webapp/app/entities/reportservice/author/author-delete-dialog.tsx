...
export const AuthorDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.reportservice.author.updateSuccess);

  const handleClose = () => {
    navigate(`/reportservice/author${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reportserviceApp.reportserviceAuthor.delete.question">
        <Translate contentKey="reportserviceApp.reportserviceAuthor.delete.question" interpolate={{ id: authorEntity.id }}>
