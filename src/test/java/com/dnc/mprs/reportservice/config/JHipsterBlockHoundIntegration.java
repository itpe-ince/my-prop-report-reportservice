...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.dnc.mprs.reportservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.dnc.mprs.reportservice.security.DomainUserDetailsService", "createSpringSecurityUser");
