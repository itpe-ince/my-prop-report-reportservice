...
public class InfrastructureTestSamples {
    ...
    public static Infrastructure getInfrastructureSample1() {
        return new Infrastructure().id(1L).reportId(1L).infraName("infraName1").infraDistance(1).remarks("remarks1");
    }

    public static Infrastructure getInfrastructureSample2() {
        return new Infrastructure().id(2L).reportId(2L).infraName("infraName2").infraDistance(2).remarks("remarks2");
    }
