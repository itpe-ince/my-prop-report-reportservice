...
public class EntranceTestSamples {
    ...
    public static Entrance getEntranceSample1() {
        return new Entrance().id(1L).entranceName("entranceName1").pantryPresence("pantryPresence1").remarks("remarks1");
    }

    public static Entrance getEntranceSample2() {
        return new Entrance().id(2L).entranceName("entranceName2").pantryPresence("pantryPresence2").remarks("remarks2");
    }
